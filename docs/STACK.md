...
| Motion / activity | **Adafruit LIS3DH** | Low-power wake-on-motion via INT1 |
...
| LIS3DH accelerometer | 24-hour no-movement rule + wake-on-motion |
...
- **Power-first choices** — RadioLib power control, AXP2101 rail shutoff, LIS3DH wake-on-motion: every library pick was made for the ~2-week battery target.
